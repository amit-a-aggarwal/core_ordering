...
class OrderStatusDialog(CancelAndHelpDialog):
    def __init__(self,luis_recognizer: OrderingRecognizer, dialog_id: str = None):
        super(OrderStatusDialog, self).__init__(dialog_id or OrderStatusDialog.__name__)
    ...
    async def final_step(self, step_context: WaterfallStepContext) -> DialogTurnResult:
        ...
        msg_txt = "Your order is under processing"
        dict = {}
